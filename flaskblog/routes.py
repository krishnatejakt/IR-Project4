...
def search():
    ...
    if form.validate_on_submit():
        if(form.search.data!=''):
            ...
            data = urlopen('http://100.25.155.102:8983/solr/IRF20P4/select?defType=edismax&q=full_text%3A'+query_term+'&rows=20&sort=influencer_score%20desc&stopwords=true&wt=json')
